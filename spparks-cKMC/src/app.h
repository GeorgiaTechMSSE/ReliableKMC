 ...
 ******************************/  
 struct csite {		//site info with sorting criteria of kvalue
	int index;
	double keyvalue;
  };
/*****************************/ 
 ...
 *     - By Yan Wang (June  2010)
 ******************************/  
  IntervalItem time_intval;	//the interval of current simulation time in best-case and worst-case scenarios
/*****************************/ 
