 ...
 ******************************/  
	IntervalItem propensity_intval;
/*****************************/
 ...
 *     - By Yan Wang (June  2010)
 ******************************/  
	IntervalItem **hbarrier_intval;
	IntervalItem **sbarrier_intval;
	IntervalItem  deprate_intval;
/*****************************/
 ...
 *     - By Yan Wang (June  2010)
 ******************************/  
  void site_event_intval_linear(int, class RandomPark *);
  void add_event(int, int, IntervalItem, double, int);
  IntervalItem site_propensity_intval(int);
  IntervalItem site_propensity_intval_linear(int);
/*****************************/
