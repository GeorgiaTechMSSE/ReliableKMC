 ...
 ******************************/  
  virtual IntervalItem site_propensity_intval(int) = 0;
/*****************************/ 
 ...
 *     - By Yan Wang (June  2010)
 ******************************/  
  IntervalItem *propensity_intval;	//the list of total interval propensities at each site
    int *isiteList;					//the list of sites as a random set to fire for each iteration
/*****************************/ 
