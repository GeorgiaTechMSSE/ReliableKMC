...
//printf("Output->setup():line84:dump_time=%f ndump=%d\n",dump_time,ndump);  
...
//printf("Output->setup():line98:ndiag=%d\n",ndiag);  
    if  (diaglist[i]->stats_flag) diaglist[i]->compute();
//printf("Output->setup():line100:diag_time=%f ndiag=%d\n",diag_time,ndiag);  
...
//printf("Output->setup():line122 tnext=%f\n",tnext);  
  return tnext;
}
