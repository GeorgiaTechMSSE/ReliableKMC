 ...
 ******************************/
void SolveGroup::init_intval(int n, IntervalItem * propensity_intval)
{
}

void SolveGroup::update_intval(int n, int *indices, IntervalItem *propensity_intval)
{
}

int SolveGroup::event_intval(int *eventList, IntervalItem *pdt)
{
	return 0;
}
/*********************************/
