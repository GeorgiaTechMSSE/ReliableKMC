 ...
 ******************************/
void SolveTree::init_intval(int n, IntervalItem * propensity_intval)
{
}

void SolveTree::update_intval(int n, int *indices, IntervalItem *propensity_intval)
{
}

int SolveTree::event_intval(int *eventList, IntervalItem *pdt)
{
	return 0;
}
/*********************************/
